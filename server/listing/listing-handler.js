...
module.exports = async (req, res) => {
    ...
    const filteredList = listingFilter(listings, {offset: 0, limit: 10, ...query});
    const data = filteredList.slice(offset, Number.parseInt(offset) + Number.parseInt(limit));
    ...
    res.status(200).send({
        ...
        searchTotal: filteredList.length,
    });
};
